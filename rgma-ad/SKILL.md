---
name: rgma-ad
description: "Create ad concepts for Rio Grande Marketing Agency, a Las Cruces NM web design business. Input: a service offering, a customer pain point, or a real client website launch. Thinks through the specific local business owner and their pain moment, picks a virality lever, writes a timed presenter script with emotion notes, and delivers emoji-formatted captions carrying the RGMA contact block. Use for anything RGMA: website ads, agency UGC concepts, scripts selling web design or website management packages, client launch announcements. Generation prompts are produced by chatgpt-image-2 and seedance-2."
---

# RGMA — Ad Concepts + Scripts from an Offering

Rio Grande Marketing Agency builds clean, professional websites for local businesses in Las Cruces, NM — multiple website packages (management starting at $29/mo), local support, real ownership. This skill turns an offering, pain point, or client launch into video concepts, scripts, and captions. It does NOT write generation prompts — when a concept needs them, use `chatgpt-image-2` and `seedance-2`.
...
3. **The one promise:** which single RGMA value answers it — not stressing you out / not stuck alone / real ownership / local support / affordability (packages start at $29/mo). One per ad.
...
The contact block (📞 + 🔗) appears in EVERY caption. Price angle: say "starting at $29/mo" unless the user names a specific package — NEVER invent a package price; the package list lives in references/user-findings.md. Three variations, each a different angle:
...
3. **Direct offer** — the relevant package + what they get, calm and concrete (default: "starting at $29/mo").
...
- Constants: 📞 (575) 496 6852 · 🔗 riograndema.com · "starting at $29/mo" (full package list: references/user-findings.md) · "Affordable websites. Local support. Real ownership." · "Get your website started today."
...
7. Is every price stated either "starting at $29/mo" or a real package from user-findings — never invented?
