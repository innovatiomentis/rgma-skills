...
These often make the result look fake, plastic, over-rendered, or like stock photography.
...
Use negative instructions based on likely failure points. Do not create giant negative lists unless needed.
...
```text
Create a RAW iPhone photo, vertical 9:16, not a professional photograph. It should look like a real candid frame grabbed from a phone video.
...
```text
Create a realistic documentary-style photo for [use case].
...
```text
Create a realistic product image for [use case].
...
```text
Create a realistic website hero image for [business/use case], 16:9.
